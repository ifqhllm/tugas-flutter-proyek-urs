...
class PentingnyaIlmuDarahPage extends StatefulWidget {
  final int materialNumber;

  const PentingnyaIlmuDarahPage({super.key, this.materialNumber = 3});

  @override
  State<PentingnyaIlmuDarahPage> createState() =>
      _PentingnyaIlmuDarahPageState();
}

class _PentingnyaIlmuDarahPageState extends State<PentingnyaIlmuDarahPage> {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          _buildContentBox(
            text:
                'Memperlajari ilmu darah kewanitaan sangat penting karena berhubungan langsung dengan tatacara ubudiyah dan mu\'amalah, seperti:',
          ),
