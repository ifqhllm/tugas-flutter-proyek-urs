...
class PengertiaNifasPage extends StatefulWidget {
  final int materialNumber;

  const PengertiaNifasPage({super.key, this.materialNumber = 2});

  @override
  State<PengertiaNifasPage> createState() => _PengertiaNifasPageState();
}

class _PengertiaNifasPageState extends State<PengertiaNifasPage> {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          _buildContentBox(
            text:
                'Nifas secara istilah adalah darah yang keluar dari vagina setelah keluarnya bayi dari kandungan, dengan syarat keluarnya darah tetap dalam masa 15 hari setelah keluarnya bayi, jika keluarnya darah setelah 15 hari dari keluarnya bayi maka hukum darah tersebut dihukumi haid.',
          ),
          ...
          _buildContentBox(
            text: 'Catatan:\n'
                ...
                '•\tJika bayi yang dilahirkan kembar, maka yang akan dihukumi nifas adalah darah yang keluar setelah bayi terakhir dilahirkan, jika keluarnya darah sebelum bayi terakhir keluar maka darah tersebut dinamakan darah fasad (darah penyakit)\n'
