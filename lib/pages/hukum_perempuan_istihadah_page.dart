...
class HukumPerempuanIstihadahPage extends StatefulWidget {
  final int materialNumber;

  const HukumPerempuanIstihadahPage({super.key, this.materialNumber = 21});

  @override
  State<HukumPerempuanIstihadahPage> createState() =>
      _HukumPerempuanIstihadahPageState();
}

class _HukumPerempuanIstihadahPageState
    extends State<HukumPerempuanIstihadahPage> {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          _buildContentBox(
            text:
                'Hukum bagi perempuan yang istihadah dalam beribadah adalah sama seperti orang yang bersuci secara darurat (bersuci najis besar), dimana setiap akan melakukan amalan fardhu harus bersuci terlebih dahulu. Untuk hukum di luar ibadah adalah sama seperti perempuan normal.',
          ),
