...
class LaranganHaidNifasPage extends StatefulWidget {
  final int materialNumber;

  const LaranganHaidNifasPage({super.key, this.materialNumber = 10});

  @override
  State<LaranganHaidNifasPage> createState() => _LaranganHaidNifasPageState();
}

class _LaranganHaidNifasPageState extends State<LaranganHaidNifasPage> {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          _buildContentBox(
            text:
                'Ada pun larangan bagi perempuan haid hathlah sebagai berikut:',
          ),
          ...
          _buildContentBox(
            text: '•\tSholat\n'
                ...
                '•\tBerhubungan badan\n'
                '•\tDicerai\n'
                '•\tBersuci dengan niat Ibadah kecuali dengan niat membersihkan diri dan menyegarkan badan',
          ),
