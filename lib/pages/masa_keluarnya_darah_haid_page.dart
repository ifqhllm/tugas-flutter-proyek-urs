    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          _buildContentBox(
            text: 'Ada pun masa keluarnya haid sebagai berikut:',
          ),
          const SizedBox(height: 12),
          _buildContentBox(
            text:
                '•\tPaling sedikitnya masa haid hathlah 1 hari 1 malam (24 jam)\n'
                '•\tPaling banyaknya masa haid hathlah 15 hari 15 malam (Setengah bulan)\n'
                '•\tPada umumnya masa haid hathlah 6 – 7 hari',
          ),
