...
class WarnaDarahHaidPage extends StatefulWidget {
  final int materialNumber;

  const WarnaDarahHaidPage({super.key, this.materialNumber = 5});

  @override
  State<WarnaDarahHaidPage> createState() => _WarnaDarahHaidPageState();
}

class _WarnaDarahHaidPageState extends State<WarnaDarahHaidPage> {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          _buildContentBox(
            text: 'Macam – macrom warna haid terbagi menjadi 5 macam, yaitu:\n'
                '•\tHitam\n'
                '•\tMerah\n'
                '•\tOrange\n'
                '•\tKuning\n'
          ...
          _buildContentBox(
            text: 'Ada pun sifat darah terbagi menjadi 4 macrom, yaitu:\n'
                '•\tKental\n'
                '•\tBerbau\n'
                '•\tKental dan berbau\n'
                '•\tTak kental dan tak berbau',
          ),
