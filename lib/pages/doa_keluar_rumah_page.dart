...
class DoaKeluarRumahPage extends StatefulWidget {
  final int materialNumber;

  const DoaKeluarRumahPage({super.key, this.materialNumber = 6});

  @override
  State<DoaKeluarRumahPage> createState() => _DoaKeluarRumahPageState();
}

class _DoaKeluarRumahPageState extends State<DoaKeluarRumahPage> {
      ...
      child: Column(
        children: [
          ...
          const Padding(
            ...
            child: Text(
              'Membaca doa ketika keluar rumah merupakan anjuran agar senantiasa mendapat perlindungan dari Allah SWT dalam setiap langkah. Berikut ini adalah doa yang dibaca saat keluar rumah:',
              style: TextStyle(
                fontSize: 14,
                fontFamily: 'Poppins',
          ...
          _buildContentBox(
            ...
            translation: 'Artinya: "Dengan nama Allah, aku bertawakal kepada Allah. Tidak ada daya dan kekuatan kecuali dengan (pertolongan) Allah."',
          ),
    ...
    return Container(
      ...
      child: const Row(
        ...
        children: [
          ...
          Expanded(
            child: SelectableText(
              "Membaca doa ini merupakan sunnah Rasulullah SAW agar mendapat penjagaan dan perlindungan dari segala bahaya.",
              style: TextStyle(
                color: Color(0xFF8B4513),
                fontSize: 14,
                fontFamily: 'Poppins',
