...
class MengatasiNyeriHaidPage extends StatefulWidget {
  final int materialNumber;

  const MengatasiNyeriHaidPage({super.key, this.materialNumber = 18});

  @override
  State<MengatasiNyeriHaidPage> createState() => _MengatasiNyeriHaidPageState();
}

class _MengatasiNyeriHaidPageState extends State<MengatasiNyeriHaidPage> {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          _buildContentBox(
            text: 'Cara mengatasi nyeri haid hathlah sebagai berikut:',
          ),
          const SizedBox(height: 12),
          _buildContentBox(
            text:
                '•\tMemberikan kompres hangat di perut bagian bawah yang terasa nyeri atau kram\n'
                '•\tMemperbanyak aktivitas fisik atau olahraga, teknik relaksasi seperti meditasi, yoga, dan latihan pernapasan\n'
                ...
                '•\tMengurangi stress\n'
                '•\tMenggunakan obat pereda nyeri haid',
          ),
