...
class DzikirPagiPage extends StatefulWidget {
  ...
  const DzikirPagiPage({super.key, this.materialNumber = 1});
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          _buildContentBox(
            title: '3. Baca Doa I',
            arabic: 'أَصْبَحْنَا وَأَصْبَحَ الْمُلْكُ لِلَّهِ وَالْحَمْدُ لِلَّهِ لَا إِلَهَ إِلَّا اللهُ وَحْدَهُ لَا شَرِيكَ لَهُ لَهُ الْمُلْكُ وَلَهُ الْحَمْدُ وَهُوَ عَلَى كُلِّ شَيْءٍ قَدِيرُ اللَّهُمَّ أَسْأَلُكَ خَيْرَ مَا فِي هَذَا الْيَوْمِ وَخَيْرَ مَا بَعْدَهُ وَأَعُوْذُ بِكَ مِنْ شَرِّ مَا فِي هَذَا الْيَوْمِ وَشَرِّ مَا بَعْدَهُ اللَّهُمَّ إِنِّي أَعُوْذُ بِكَ مِنَ الْكَسَلِ وَسُوْءِ الْكِبَرِ اللَّهُمَّ إِنِّي أَعُوْذُ بِكَ مِنْ عَذَابٍ فِي النَّارِ وَعَذَابٍ فِي الْقَبْرِ.',
            latin: 'Ashbahnaa wa ashbahal mulku lillaahi walhamdulillaahi laa ilaaha illallaahu wahdahuu laa syariika lah, lahul mulku walahul hamdu wahuwa \'alaa kuli syai-in qadiir. Allaahumma as-aluka khaira maa fii haadzal yaumi wa khaira maa ba\'dahuu wa a\'uudzubika min syarri maa fii haadzal yaumi wasyarri maa ba\'dahuu. Allaahumma innii a\'uudzubika minal kasali wasuu-il kibari. Allaahumma innii a\'uudzubika min \'adzaabin finnaari wa \'adzaabin fil qabr.',
            translation: '"Kami telah memasuki waktu pagi dan kerajaan hanya milik Allah, segala puji bagi Allah. Tidak ada Tuhan (yang berhak disembah) kecuali Allah Yang Maha Esa, tidak ada sekutu bagi-Nya. Bagi-Nya kerajaan dan bagi-Nya pujian. Dialah Yang Maha Kuasa atas segala sesuatu. Ya Allah, aku mohon kepada-Mu kebaikan pada hari ini dan kebaikan setelahnya. Aku berlindung kepada-Mu dari kejahatan hari ini dan kejahatan setelahnya. Ya Allah, aku berlindung kepada-Mu dari kemalasan dan kejelekan pada hari tua. Ya Allah, aku berlindung kepada-Mu dari siksaan di neraka dan kubur."',
          ),
          const SizedBox(height: 12),
          _buildContentBox(
            title: '4. Baca Dzikir I',
            arabic: 'اللَّهُمَّ بِكَ أَصْبَحْنَا، وَبِكَ أَمْسَيْنَا، وَبِكَ نَحْنَا، وَبِكَ نَمُوْتُ وَإِلَيْكَ الْمَصِيرُ.',
            latin: 'Allaahumma bika ashbahnaa, wabika amsainaa, wabika nahnaa, wabika namuutu wa-ilaikal mashiir.',
            translation: '"Ya Allah, dengan rahmat dan pertolongan-Mu kami memasuki waktu pagi, dan waktu sore. Dengan rahmat dan pertolongan-Mu kami hidup dan kami mati. Dan kepada-Mu tempat kembali."',
          ),
          const SizedBox(height: 12),
          _buildContentBox(
          ...
          _buildContentBox(
            ...
            arabic: 'أَصْبَحْنَا عَلَى فِطْرَةِ الْإِسْلَامِ وَعَلَى كَلِمَةِ الْإِخْلَاصِ وَعَلَى دِيْنِ نَبِيِّنَا مُحَمَّدٍ صَلَّ اللَّهُ عَلَيْهِ وَسَلَّمَ، وَعَلَى مِلَّةِ أَبِيْنَا إِبْرَاهِيمَ، حَنِيفًا مُسْلِمًا وَمَا كَانَ مِنَ الْمُشْرِكِينَ.',
            latin: 'Ashbahnaa \'alaa fithratil islaami wa \'alaa kalimatil ikhlaashi, wa \'alaa diini nabiyyinaa muhammadin shallallaahu \'alaihi wasallama, wa \'alaa millati abiinaa ibraahiima, haniifam muslimaw wamaa kaana minal musyrikiin.',
            translation: '"Pada waktu pagi kami memegang agama Islam, kalimat ikhlas, agama Nabi kita Muhammad, dan agama ayah kami Ibrahim, yang berdiri di atas jalan yang lurus, muslim dan tidak tergolong orang-orang musyrik.',
          ),
          const SizedBox(height: 12),
          _buildContentBox(
          ...
          _buildContentBox(
            ...
            latin: 'Subhaanallaahi wabihamdihi \'adada khalqihii, waridhaa nafsihii, wazinata \'arsyihii wamidaada kalimaatihi.',
            translation: '"Maha Suci Allah, aku memuji-Nya sebanyak makhluk-Nya, sejauh kerelaan-Nya, seberat timbangan arsy-Nya dan sebanyak tinta kalimat- Nya."',
          ),
          const SizedBox(height: 12),
          _buildContentBox(
            title: '15. Baca Dzikir IX',
            arabic: 'اللَّهُمَّ إِنِّي أَسْأَلُكَ عِلْمًا نَافِعًا، وَرِزْقًا طَيِّبًا، وَعَمَلًا مُتَقَبَّلا.',
            latin: 'Allaahumma innii as-aluka \'ilman naafi\'an, warizqan thayyiban, wa \'amalan mutaqabbala.',
            translation: '"Ya Allah, sungguh aku memohon kepada-Mu ilmu yang manfaat, rezeki yang baik dan amal yang diterima." (HR Ibnu As-Sunni dalam Amalul Yaum wal Lailah, dan Ibnu Majah. Isnadnya hasan menurut Abdul Qadir dan Syu\'aib Al-Arna\'uth dalam tahqiq Zadul Ma\'ad 2/375)',
          ),
          const SizedBox(height: 12),
          _buildContentBox(
            title: '16. Istighfar (100 Kali)',
            arabic: 'أَسْتَغْفِرُ اللهَ وَأَتُوبُ إِلَيْهِ.',
            latin: 'Astaghfirullaaha waatuubu ilaiih.',
            translation: '"Aku meminta ampun kepada Allah dan bertaubat kepada-Nya."',
          ),
