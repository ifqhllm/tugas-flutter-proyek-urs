...
class PengertiaHaidPage extends StatefulWidget {
  final int materialNumber;

  const PengertiaHaidPage({super.key, this.materialNumber = 1});

  @override
  State<PengertiaHaidPage> createState() => _PengertiaHaidPageState();
}

class _PengertiaHaidPageState extends State<PengertiaHaidPage> {
