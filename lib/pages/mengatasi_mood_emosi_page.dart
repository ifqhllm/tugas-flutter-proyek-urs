...
class MengatasiMoodEmosiPage extends StatefulWidget {
  final int materialNumber;

  const MengatasiMoodEmosiPage({super.key, this.materialNumber = 16});

  @override
  State<MengatasiMoodEmosiPage> createState() => _MengatasiMoodEmosiPageState();
}

class _MengatasiMoodEmosiPageState extends State<MengatasiMoodEmosiPage> {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          _buildContentBox(
            text:
                'Cara mengatasi perubahan mood emosi hathlah sebagai berikut:',
          ),
          const SizedBox(height: 12),
          _buildContentBox(
            text: '•\tOlahraga teratur\n'
                '•\tKonsumsi makanan sehat, bernutrisi, serta halal\n'
                '•\tIstirahat yang cukup\n'
                '•\tMemperbanyak minum air putih\n'
                '•\tMelakukan kegiatan relaksasi\n'
                '•\tMembaca wirid harian atau sholawat',
          ),
