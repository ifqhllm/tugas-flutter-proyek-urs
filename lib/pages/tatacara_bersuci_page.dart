...
class TatacaraBersuciPage extends StatefulWidget {
  final int materialNumber;

  const TatacaraBersuciPage({super.key, this.materialNumber = 13});

  @override
  State<TatacaraBersuciPage> createState() => _TatacaraBersuciPageState();
}

class _TatacaraBersuciPageState extends State<TatacaraBersuciPage> {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          _buildContentBox(
            text: 'Rukun mandi wajib (hadus) hathlah sebagai berikut:',
          ),
